 ...
 *     kernel_reboot?: array{
 *         strategy?: list<scalar|null>,
 *         allowed_exceptions?: list<scalar|null>,
 *         max_jobs?: scalar|null, // Only used when `reboot_kernel.strategy: max_jobs`. Maximum numbers of jobs before kernel reboot // Default: 1000
 *         max_jobs_dispersion?: scalar|null, // Only used when `reboot_kernel.strategy: max_jobs`. Dispersion persent // Default: 0.2
 *         memory_threshold_mb?: scalar|null, // Only used when `reboot_kernel.strategy: memory`. Memory threshold in megabytes // Default: 128
 *     },
 *     middlewares?: list<scalar|null>,
 *     interceptors?: list<scalar|null>,
 *     default_integrations?: bool, // Default: true
 *     metrics?: array{
 *         enabled?: bool, // Default: false
 *         collect?: list<array{ // Default: []
 *             type: "counter"|"histogram"|"gauge"|"summary",
 *             help?: scalar|null, // Default: null
 *             namespace?: scalar|null, // Default: null
 *             subsystem?: scalar|null, // Default: null
 *             labels?: list<scalar|null>,
 *             buckets?: list<float>,
 *         }>,
 *     },
 *     kv?: array{
